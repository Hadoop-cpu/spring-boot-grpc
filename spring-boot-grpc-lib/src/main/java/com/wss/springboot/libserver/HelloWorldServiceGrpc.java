...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.wss.springboot.libserver.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.wss.springboot.libserver.Person,
      com.wss.springboot.libserver.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.wss.springboot.libserver.Person.class,
      responseType = com.wss.springboot.libserver.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.wss.springboot.libserver.Person,
      com.wss.springboot.libserver.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.wss.springboot.libserver.Person, com.wss.springboot.libserver.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.wss.springboot.libserver.Person, com.wss.springboot.libserver.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wss.springboot.libserver.Person.getDefaultInstance()))
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.wss.springboot.libserver.Person,
                com.wss.springboot.libserver.Greeting>(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.wss.springboot.libserver.Person) request,
              (io.grpc.stub.StreamObserver<com.wss.springboot.libserver.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.wss.springboot.libserver.Greeter.getDescriptor();
    }
